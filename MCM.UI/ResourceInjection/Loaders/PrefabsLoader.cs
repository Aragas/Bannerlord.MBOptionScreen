...
namespace MCM.UI.ResourceInjection
{
    ...
    {
        public static XmlDocument SettingsItemViewView() => Load("MCM.UI.GUI.Views.SettingsItemView.xml");
        ...
        {
            resourceInjector.InjectPrefab("SettingsItemView_v3", SettingsItemViewView());
