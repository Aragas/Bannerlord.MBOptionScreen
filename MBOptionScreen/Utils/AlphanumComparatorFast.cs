...
{
    internal class AlphanumComparatorFast : IComparer<SettingPropertyGroupDefinition>, IComparer<SettingPropertyDefinition>
    {
        ...
        public int Compare(SettingPropertyDefinition x, SettingPropertyDefinition y)
        {
