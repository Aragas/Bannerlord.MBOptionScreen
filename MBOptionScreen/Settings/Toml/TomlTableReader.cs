...
namespace CommunityPatch {
  ...
  public class TomlTableReader: ITomlReader {

    private readonly TableSyntaxBase _toml;

    [PublicAPI]
    public TomlTableReader(TableSyntaxBase toml) {
      _toml = toml;
    }
    ...
    public void DeleteConfig([NotNull] string key)
      => _toml.Items.RemoveChildren(GetConfig(key));
