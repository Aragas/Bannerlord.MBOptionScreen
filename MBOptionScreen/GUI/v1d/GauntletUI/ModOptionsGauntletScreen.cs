...
using MBOptionScreen.GUI.v1d.ResourceInjection;
using MBOptionScreen.GUI.v1d.ViewModels;
...
namespace MBOptionScreen.GUI.v1d.GauntletUI
{
    [Version("e1.0.0",  200)]
    [Version("e1.0.1",  200)]
    [Version("e1.0.2",  200)]
    ...
    public class ModOptionsGauntletScreen : MBOptionScreen
    {
        ...
        protected override void OnInitialize()
        {
            ...
            _gauntletMovie = _gauntletLayer.LoadMovie("ModOptionsView_v1d", _dataSource);
