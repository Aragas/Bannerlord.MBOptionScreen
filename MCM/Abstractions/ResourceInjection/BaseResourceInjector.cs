...
namespace MCM.Abstractions.ResourceInjection
{
    public abstract class BaseResourceInjector
    {
        ...
        public static BaseResourceInjector Instance =>
        ...
        public static WidgetPrefab? RequestMovie(string movie) => DI.GetImplementations<IResourceLoader, ResourceLoaderWrapper>(ApplicationVersionUtils.GameVersion())
