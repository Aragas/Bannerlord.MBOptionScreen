...
namespace MCM.Implementation.Settings.Base.PerCampaign
{
    ...
    [Version("e1.4.0",  1)]
    [Version("e1.4.1",  1)]
    public class MCMPerCampaignSettingsWrapper : BaseMCMPerCampaignSettingsWrapper
    {
        ...
        public MCMPerCampaignSettingsWrapper(object @object) : base(@object)
        {
            var type = @object.GetType();
            CharacterIdProperty = AccessTools.Property(type, nameof(CampaignId));
            ...
            IsCorrect = CharacterIdProperty != null && IdProperty != null && ModuleFolderNameProperty != null &&
                        ...
                        DiscovererProperty != null;
        }

        public override void OnPropertyChanged([CallerMemberName] string? propertyName = null) =>
            OnPropertyChangedMethod?.Invoke(Object, new object[] { propertyName! });

        protected override BaseSettings CreateNew() => new MCMPerCampaignSettingsWrapper(CreateNewMethod!.Invoke(Object, Array.Empty<object>()));
        protected override BaseSettings CopyAsNew() => new MCMPerCampaignSettingsWrapper(CopyAsNewMethod!.Invoke(Object, Array.Empty<object>()));
        ...
        public override IDictionary<string, Func<BaseSettings>> GetAvailablePresets()
        {
            ...
            foreach (DictionaryEntry pair in dict)
                returnDict.Add((string) pair.Key, () => new MCMPerCampaignSettingsWrapper(((Func<object>) pair.Value).Invoke()));
            return returnDict;
        }
        ...
        public override List<SettingsPropertyGroupDefinition> GetSettingPropertyGroups()
        {
            if (GetSettingPropertyGroupsMethod == null ||
                ...
                GetUnsortedSettingPropertyGroupsMethod.DeclaringType.GetGenericTypeDefinition() == typeof(AttributePerCampaignSettings<>)))
