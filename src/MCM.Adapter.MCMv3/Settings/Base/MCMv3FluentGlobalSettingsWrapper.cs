...
namespace MCM.Adapter.MCMv3.Settings.Base
{
    ...
    {
        private static string GetId(object @object) => AccessTools2.Property(@object.GetType(), nameof(MCMv3BaseSettings.Id))?.GetValue(@object) as string ?? "ERROR";
        private static string GetDisplayName(object @object) => AccessTools2.Property(@object.GetType(), nameof(MCMv3BaseSettings.DisplayName))?.GetValue(@object) as string ?? "ERROR";
        private static string GetFolderName(object @object) => AccessTools2.Property(@object.GetType(), nameof(MCMv3BaseSettings.FolderName))?.GetValue(@object) as string ?? "ERROR";
        private static string GetSubFolder(object @object) => AccessTools2.Property(@object.GetType(), nameof(MCMv3BaseSettings.SubFolder))?.GetValue(@object) as string ?? "ERROR";
        private static string GetFormat(object @object) => AccessTools2.Property(@object.GetType(), nameof(MCMv3BaseSettings.Format))?.GetValue(@object) as string ?? "memory";
        private static int GetUIVersion(object @object) => AccessTools2.Property(@object.GetType(), nameof(MCMv3BaseSettings.UIVersion))?.GetValue(@object) as int? ?? 1;
        private static char GetSubGroupDelimiter(object @object) => AccessTools2.Property(@object.GetType(), "SubGroupDelimiter")?.GetValue(@object) as char? ?? '/';
