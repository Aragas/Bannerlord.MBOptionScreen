    ...
    public sealed class SubModule : MBSubModuleBase
    {
        ...
        protected override void OnSubModuleLoad()
        {
            ...
            Harmony.Patch(
                ...
                postfix: new HarmonyMethod(AccessTools2.Method(typeof(SubModule), nameof(OnAfterSetInitialModuleScreenAsRootScreen))));
        }
        ...
        protected override void OnSubModuleUnloaded()
        {
            ...
            Harmony.Unpatch(
                AccessTools2.Method(typeof(Module), "SetInitialModuleScreenAsRootScreen"),
                AccessTools2.Method(typeof(SubModule), nameof(OnAfterSetInitialModuleScreenAsRootScreen)));
        }
    }
}